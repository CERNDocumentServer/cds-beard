...
from invenio_beard.matching import do_matching
...
class TestMatching(unittest.TestCase):
    ...
    def test_the_same_clusters(self):
        ...
        match = do_matching(signatures_before, signatures_after)
    ...
    def test_cluster_adding(self):
        ...
        match = do_matching(partition_before, partition_after)
    ...
    def test_cluster_removal(self):
        ...
        match = do_matching(partition_before,
                            partition_after)
    ...
    def test_wang_signtures(self):
        ...
        self.assertEquals(match, (
            [[(u'158992', u'x158992')]],
            [[u'x623638'], [u'x623639']], [['vx623638'], ['vx623639']]))
